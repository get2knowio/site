...
export default function ProjectDetail({
  ...
  const isSideQuest = project.tier === 'side-quest';
  const status = isSideQuest
    ? { label: 'From the Bench', opacity: 1 }
    : project.status ? statusConfig[project.status] : null;
